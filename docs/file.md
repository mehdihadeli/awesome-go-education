...
- [Working with files using ioutil package](https://medium.com/rungo/working-with-files-using-ioutil-package-2c526064febb)
- [Introduction to Streams and Buffers](https://medium.com/rungo/introduction-to-streams-and-buffers-d148c0cda0ad)
- [Working with files and file system: A low-level introduction](https://medium.com/rungo/working-with-files-and-file-system-a-low-level-introduction-825ea3bac5f9)
- [Read a file (stdin) line by line](https://yourbasic.org/golang/read-file-line-by-line/)