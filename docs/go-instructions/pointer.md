...
## 📕 Articles
- [Pointer type - Practical Go Lessons](https://www.practical-go-lessons.com/chap-15-pointer-type)
...
- [The Proper Use of Pointers in Go (Golang)](https://qvault.io/golang/the-proper-use-of-pointers-in-go-golang/)
