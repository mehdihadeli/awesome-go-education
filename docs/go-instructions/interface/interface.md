...
## 📕 Articles
- [Interfaces - Practical Go Lessons](https://www.practical-go-lessons.com/chap-16-interfaces)
...
- [Interface names Conventions - Effective Go](https://go.dev/doc/effective_go#interface-names)
- [Interface naming convention in Golang](https://medium.com/@dotronglong/interface-naming-convention-in-golang-f53d9f471593)
